...
odir = "03_subset_pericytes_v1";dir.create(odir)
...
save_path = "/volumes/lab/users/tapsi/projects/bcap/analysis/20201212_final2/03_subset_pericytes_v1/"
...
data_folder = "figure_1_v1"
save_path = "/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_pericytes_v1/"
...
tum = readRDS(file = paste0(wd, data_folder,"/fibroperi_tk1.rds"))

# subset ---------
Idents(tum) <- "final_group1"
tum_sub = subset(tum, idents = "Pericytes") #subset object
tum_sub_cells = WhichCells(object = tum, idents = "Pericytes") #subset epi_lumhr cells #83891 cells
...
write.csv(tum_sub_cells, file = glue("{save_path}/pericyte_cells_v1.csv"))
...
dims = 25; k.param = 20; cols = colors_dark; var_split = "sheet_exp_proc"; var_scale = "nCount_RNA"
...
mark_out = func_markers_vst(clus_out = tum, char_ident = char_ident, fts1 = ht_fts1, dims = dims, k.param = k.param, cols = colors_dark, 
                            save_path = save_path)
