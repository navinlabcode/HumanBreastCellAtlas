...
odir = "03_subset_lumhr_v2";dir.create(odir)
...
data_folder = "03_subset_lumhr_v1"
save_path = "/volumes/lab/users/tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_v2/"
...
data_folder = "03_subset_lumhr_v1"
save_path = "/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_v2/"
...
seu_object = read_rds(glue("{data_folder}/tum_sub_v1.rds"))
...
char_ident = "integrated_snn_res.0.075"
...
p2 = DimPlot(clus_out, group.by = "integrated_snn_res.0.075", cols = colors_dark, label = T)
...
clus_out = read_rds("/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_v2/dim_35k_20_nCount_RNA_sheet_exp_proc_tum.integrated.ns2_method_9.rds")
markers = read.csv("/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_v2/dims_35k_20_tum.integrated.ns_RNA_markers_intgeratedassay_integrated_snn_res.0.075_vst_method_9.csv")
...
DoHeatmap(tum, features = top10$gene, group.colors = colors_dark) + NoLegend()
...
Idents(tum) <- "integrated_snn_res.0.075"
...
FeaturePlot(tum, c("rna_PIP", "rna_FASN", "rna_KRT17", "rna_STC1"))
dev.off()
...
clus_out$cellstate_tk2[clus_out$integrated_snn_res.0.075 %in% c("0")] = "lhr_EGLN3"
clus_out$cellstate_tk2[clus_out$integrated_snn_res.0.075 %in% c("1")] = "lhr_FASN"
clus_out$cellstate_tk2[clus_out$integrated_snn_res.0.075 %in% c("2")] = "lhr_PIP"
clus_out$cellstate_tk2[clus_out$integrated_snn_res.0.075 %in% c("3")] = "lhr_EGLN3"
