...
odir = "03_subset_lumsec_20samp_v2";dir.create(odir)
...
save_path = "/volumes/lab/users/tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumsec_20samp_v2/"
...
save_path = "/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumsec_20samp_v2/"
...
tum_sub = read_rds(paste0(wd,data_folder, "/epi_lumsec_sub_3hr_b2_reduction_v1.rds"))
...
# FeaturePlot(seu_obj, "rna_SPINK5")
# 
# remove and re run
...
png("heatmap_all_labelled_lumsec_0.3_v2.png", width=5, height=12, units = "in", res = 300)
tcell_heatmap
dev.off()
...
seu_obj$RNA_snn_res.0.3 = as.character(seu_obj$RNA_snn_res.0.3)
seu_obj$RNA_snn_res.0.3[(is.na(seu_obj$RNA_snn_res.0.3))] = "unkn"
...
p2 = DimPlot(seu_obj, reduction  = "umap", group.by = "RNA_snn_res.0.3", ncol = 1, label = T, cols = colors_dark, pt.size = 0.0001)
...
png("umap_rna0.3_split_by_pt_v3.png", width=11, height=11, units = "in", res = 300) #
DimPlot(seu_obj, reduction  = "umap", group.by = "RNA_snn_res.0.3", split.by = "final_sample_id", ncol = 6, label = F, cols = colors_dark, pt.size = 1)
dev.off()
