...
odir = "03_subset_lumhr_20samp_v1";dir.create(odir)
...
save_path = "/volumes/lab/users/tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_20samp_v1/"
...
data_folder = "03_subset_lumhr_v2"
save_path = "/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumhr_20samp_v1/"
...
tum = read_rds(paste0(wd, "03_subset_lumhr_v2/clus_out.rds"))
...
write_rds(tum_sub, "epi_lumhr_sub_3hr_b2_reduction_v1.rds")
...
png("heatmap_all_labelled_lumHR_0.2_v1.png", width=5, height=20, units = "in", res = 300)
tcell_heatmap
dev.off()
...
seu_obj <- FindClusters(seu_obj, resolution = c(0.5, 0.1, 0.05, 0.075, 0.2, 0.15, 0.3))
seu_obj <- RunUMAP(seu_obj, dims = 1:35)
write_rds(seu_obj, "seu_obj_bypt.rds")
seu_obj = read_rds("seu_obj_bypt.rds")
DimPlot(seu_obj, reduction = "umap", group.by = "RNA_snn_res.0.2")
DimPlot(seu_obj, reduction = "umap", group.by = "sheet_patient_id")
DimPlot(seu_obj, reduction = "umap", group.by = "RNA_snn_res.0.2", split.by = "sheet_patient_id")
seu_obj$RNA_snn_res.0.2 = factor(seu_obj$RNA_snn_res.0.2, levels = c("0", "1", "2", "3", "4", "5", "6"))

png("featureplot_0.2_v1.png", width=16, height=12, units = "in", res = 300)
FeaturePlot(seu_obj, c("rna_ESR1", "rna_SCGB2A2", "rna_SCGB1D2", "rna_TOP2A", "rna_S100A6", "rna_LDHA", 
                          "rna_PTN", "rna_FASN", "rna_EGR1", "rna_KRT15", "rna_PIP"))
dev.off()
...
DoHeatmap(tavg, features = unique(c("EPCAM", "ESR1","PGR","AR", "TOP2A",top10$gene)), assay = "RNA", label = TRUE,
  ...
  scale_fill_gradient2(low = "#29A7B8", mid = "white", high = "#E85041", na.value = "00000000") + 
  theme(axis.text.y = element_text(size=7.5)) -> tcell_heatmap
png("heatmap_all_labelled_lumHR_0.2_v3.png", width=5, height=16, units = "in", res = 300)
tcell_heatmap
dev.off()
