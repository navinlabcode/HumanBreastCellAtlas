...
odir = "03_subset_lumsec_v2";dir.create(odir)
...
data_folder = "03_subset_lumsec_v1"
save_path = "/volumes/lab/users/tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumsec_v2/"
...
data_folder = "03_subset_lumsec_v1"
save_path = "/volumes/core/users/tapsi/geo_tapsi/projects/bcap/analysis/20201212_final2/03_subset_lumsec_v2/"
...
tum = read_rds(path = paste0(wd, data_folder,"/dim_35k_20_nCount_RNA_sheet_exp_proc_tum.integrated.ns2_method_9.rds"))
tum$sheet_patient_id[tum$sheet_ts_sampleid %in% c("hbca25_c")] = "pt37"

VlnPlot(lact_obj,"rna_CD3D")
lact_obj_sub = subset(lact_obj, idents = c("17")) #lactation cluster
...
tum_sub = subset(tum, idents = c("3", "9", "10", "11", "14", "15", "16", "17"), invert = T) #endo_vas
